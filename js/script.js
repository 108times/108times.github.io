	...
	.ready(function() {
		...
		$('.box #top')
			.append(
				...
				// '<img alt="solar-system" classs="bg-img"
		...
		function pagePreLoad() {
			...
			if ( flag !== 1 ) {
				...
				let wge = slider.children('section')
								.remove();
			...
			switch (string) {
				case 'about':
					box_side.append(
						...
						//     string +
						//     "-page' class='page d-flex
						// justify-content-center align-items-center
						// text-center'><div class='page-bg'></div>" +
						...
						'<p>I\'m a web developer, living and studying in Almaty, Kazakhstan. My passion is creating and I find happiness in being a better me today than the me yesterday.</p><p> Feel free to take a look at my skillset on the <a id=\'about-skills-link\' class = \'link-highlighted\' href=\'#skills\' >skills page</a>, check my latest projects on the <a id=\'about-portfolio-link\' class = \'link-highlighted\' href=\'#portfolio\' >portfolio page</a> and contact me on the <a id=\'about-contact-link\' class = \'link-highlighted\' href=\'#contact\' >contact page.</a></p></div> </div> </div></section>',
					);
					break;
				...
				case 'portfolio':
					box_side.append(
						...
						'<img src="img/test-task-1.jpg" alt="" />' +
						' <h4>HTML Layout designer test task</h4>' +
						'<div id="portfolio_todolist" class="object-description-initial" >' +
						' <img id ="project-todolist" src="img/test-task-2.jpg" alt="project image#2">' +
						'<div class="key-words"><span>Pixel perfect</span><span>LESS</span><span>Semantic</span><span>Gulp</span><span>Responsive</span><span>JavaScript</span></div>' +
						'<div class="more ">' +
						'<a href="./works/test-task/index.html" class="more-btn play-btn"><img class="more-img" src="img/play.svg" alt=""/></a>' +
						'<a href="https://github.com/108times/html-layout-designer-test-task" class="more-btn github-btn"><img class="more-img" src="img/github.svg" alt=""/></a>' +
						'<a href="#" class="more-btn view-more-btn"><span>View more...</span></a>' +
						'</div>' +
						' </div>' +
						'</div>' +

						'<div class="portfolio-project-initial">' +
						'<img src="img/vegefoods.jpg" alt="" />' +
						' <h4>Shop</h4>' +
						'<div id="portfolio_portfolio" class="object-description-initial" >' +
						' <img id ="project-todolist" src="img/vegefoods2.jpg" alt="project image#2">' +
						'<div class="key-words"><span>JavaScript</span><span>SCSS</span><span>CMS</span><span>php</span><span>MVC</span><span>Responsive</span></div>' +
						'<div class="more ">' +
						'<a href="#" class="more-btn play-btn"><img class="more-img" src="img/play.svg" alt=""/></a>' +
						'<a href="https://github.com/108times/mvc-web-application" class="more-btn github-btn"><img class="more-img" src="img/github.svg" alt=""/></a>' +
						'<a href="#" class="more-btn view-more-btn"><span>View more...</span></a>' +
						'</div>' +
						' </div>' +
						'</div>' +

						'<div class="portfolio-project-initial hidden-content">' +
						...
						'<div class="more ">' +
						'<a href="#" class="more-btn play-btn"><img class="more-img" src="img/play.svg" alt=""/></a>' +
						'<a href="#" class="more-btn github-btn"><img class="more-img" src="img/github.svg" alt=""/></a>' +
						'<a href="#" class="more-btn view-more-btn"><span>View more...</span></a>' +
						'</div>' +
						' </div>' +
						'</div>' +
						...
						'<div class="key-words"><span>SPA</span><span>SASS</span><span>ui/ux design</span><span>animations</span><span>html5</span><span>Responsive</span></div>' +
						'<div class="more ">' +
						'<a href="#" class="more-btn play-btn"><img class="more-img" src="img/play.svg" alt=""/></a>' +
						'<a href="https://github.com/108times/108times.github.io" class="more-btn github-btn"><img class="more-img" src="img/github.svg" alt=""/></a>' +
						'<a href="#" class="more-btn view-more-btn"><span>View more...</span></a>' +
						'</div>' +
						' </div>' +
						'</div>' +
						...
						' </div>' +
						' </div>' +
						'<div class="portfolio-project hidden-content">' +
				...
				case 'contact':
					box_side.append(
						...
						' </a>' +
						'<div class="links">' +
						'<a href="https://vk.com/dharma6" target="_blank" class="contact-link"><img src="icons/links/vk.png"' +
						'alt=""></a>' +
						...
						'<a href="https://github.com/108times" target="_blank" class="contact-link"><img ' +
						'src="icons/links/github.png" alt=""></a>' +
						'<a href="#" target="_blank" class="contact-link"><img ' +
		...
		function navbarAppear() {
			const [ top, bottom ] = isMobile() ? [ 'auto', '50px' ] : [
				'37px',
				'0px',
			];
			$('#navbar-toggle')
		...
		let option_link = '';
		$(document)
			.on('click', 'section#about-page a', function() {
				option = 2;
				setTimeout(function() {
					option = 1;
				}, 600);
				...
				let hr      = $(this)
					.attr('href');
				option_link = hr;
				let flagg   = $('#next-toggle')
					.attr('href');
				$('#next-toggle')
					.click();

				// document.getElementById("next-toggle").setAttribute("href",
				// "#skills"); console.log("qwqweqweqweqwe" +
				// next.attr("href"));
		...
		$(document)
			.on('mouseover', '.portfolio-project', function() {
				$(this)
		...
		$(document)
			.on('mouseleave', '.portfolio-project', function() {
				$(this)
					.find('.object-description')
					.css({
							 top:    '70%',
		...
		function portfolioHover() {
			...
			console.dir(portf_pr)
			portf_pr.on('mouseover', portf_pr, function() {
				$(this).find('.object-description-initial').addClass('hover');
				[...portf_pr].forEach(item => {
					if (item === $(this)) item.style.zIndex = 10000;
					item.style.zIndex = 100
				})
				// let obj_desc = $(this)
				// 	.find('.object-description-initial');
				// obj_desc.css({
				// 				 top: '8%',
				// 			 });
					})
					...
					.on('mouseleave', portf_pr, function() {
						$(this).find('.object-description-initial').removeClass('hover');
						[...portf_pr].forEach(item => {
		...
		$('body')
			.on('DOMNodeInserted', 'section', function() {
				portfolioHover();
			});
